...
python run_sglang_softthinking.py \
    --dataset "aime2024" \
    --model_name /root/SofT-GRPO-master/saved_weight/Deepeeek-Qwen-1.5B+GRPO \
    --max_topk 30 \
...
#     --model_name /scratch/e1374322/verl-save/verl_grpo_deepscaler/8k-train/final_merged_model \
#     --max_topk 30 \
#     --max_generated_tokens 32768 \
#     --temperature 0.6 \
#     --top_p 0.95 \
