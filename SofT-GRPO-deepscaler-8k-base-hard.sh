...
# PYTHONUNBUFFERED=1 CUDA_LAUNCH_BLOCKING=1 HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m verl.trainer.main_ppo \
PYTHONUNBUFFERED=1 HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m verl.trainer.main_ppo \
...
actor_rollout_ref.rollout.noise_factor=0 \
...
trainer.project_name='verl_soft-thinking-grpo_deepscaler_gsm8k_run' \
trainer.experiment_name='8k-train-qwen3-1.7b-base-hard' \
